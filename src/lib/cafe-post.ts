...
function buildQnA(p: ParsedListing): string {
  ...
  if (hasParking(p)) pool.push([골라쓰기(['주차는 충분한가요?', '손님 차를 대달 곳이 있나요?', '주차는 몇 대나 되나요?'], s, 13), 골라쓰기([
  ...
  if (p.moveIn === '즉시입주') pool.push([골라쓰기(['입주는 언제부터 가능한가요?', '바로 들어갈 수 있나요?', '언제부터 쓸 수 있나요?'], s, 15), 골라쓰기([
  ...
  pool.push([골라쓰기(['계약 시 확인해야 할 사항이 있나요?', '계약 전에 뭐를 봐야 하나요?', '서류는 어떻게 확인하나요?'], s, 17), 골라쓰기([
