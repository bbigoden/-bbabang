...
const sections = [
  ...
  {
    title: '7. 개인정보의 파기',
    content: `부소장은 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다.\n\n- 전자적 파일 형태: 복원이 불가능한 방법으로 영구 삭제\n- 종이 문서: 분쇄기로 분쇄하거나 소각`,
  },
  {
    title: '8. 개인정보 보호책임자',
    content: `부소장은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.\n\n개인정보 보호책임자\n- 이메일: bigodennn@gmail.com\n\n기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.\n- 개인정보침해신고센터: privacy.kisa.or.kr / 국번없이 118\n- 대검찰청 사이버범죄수사단: www.spo.go.kr / 02-3480-3573`,
  },
  {
    title: '9. 쿠키의 운영 및 거부',
    content: `부소장은 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다. 이용자는 쿠키 설치에 대한 선택권을 가지고 있으며, 웹 브라우저의 설정을 통해 쿠키 저장을 거부할 수 있습니다. 단, 쿠키 저장을 거부할 경우 일부 서비스 이용에 어려움이 있을 수 있습니다.`,
  },
  {
    title: '부칙',
      ...
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="mb-6 rounded-2xl border border-blue-100 bg-blue-50 px-6 py-4">
          ...
          <p className="mt-1 text-sm text-blue-700">
            부소장은 서비스 제공에 필요한 최소한의 개인정보만 수집하며,
          ...
          <div className="space-y-8">
            {sections.map((section) => (
              <div key={section.title}>
                ...
                <p className="whitespace-pre-line text-sm leading-relaxed text-gray-600 dark:text-gray-500">
                  {section.content}
                </p>
              </div>
            ))}
