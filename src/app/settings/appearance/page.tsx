  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">기본은 시스템 설정을 따라가요</p>
          ...
          {([
            ...
            return (
              <button key={t.key} onClick={() => setTheme(t.key)}
                ...
                <Icon className={`h-6 w-6 ${active ? 'text-blue-600' : 'text-gray-500 dark:text-gray-400'}`} />
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">화면 전체 글자 크기를 조절해요</p>
          ...
          {([
            ...
            return (
              <button key={f.key} onClick={() => setFontSize(f.key)}
                ...
                <p className={`mt-1 text-[10px] font-medium ${active ? 'text-blue-700 dark:text-blue-300' : 'text-gray-500 dark:text-gray-400'}`}>{f.label}</p>
              </button>
            )
          })}
        </div>
        <p className="mt-3 text-[11px] text-gray-400">설정은 이 디바이스에만 저장돼요</p>
      </div>
