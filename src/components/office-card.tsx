...
export function OfficeCard({
  ...
  const cls = {
    ...
    meta: isDark ? 'text-gray-400' : 'text-gray-500',
    chip: isDark ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700',
    verified: isDark ? 'bg-blue-500/20 text-blue-300' : 'bg-blue-50 text-blue-700',
    ...
    chevron: isDark ? 'text-gray-400' : 'text-gray-500',
  }
