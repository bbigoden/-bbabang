...
export function NotificationBell({ userId: _userId }: { userId?: string }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-11 z-50 w-80 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-xl">
          {/* 헤더 */}
          ...
          <Link
            ...
            className="flex items-center justify-center gap-1 border-t border-gray-100 dark:border-gray-800 py-2.5 text-xs font-semibold text-blue-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-950 transition-colors rounded-b-2xl"
          >
            전체 알림 보기
